...
import {VisualComponent} from 'src/app/shared/components/visual/visual.component';
...
describe('VisualComponent', () => {
    ...
    beforeEach(async () => {
        ...
        //default case undefined element, nothing to render
        fixture.componentRef.setInput('configElement', undefined);
