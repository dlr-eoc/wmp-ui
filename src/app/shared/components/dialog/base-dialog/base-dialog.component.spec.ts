...
describe('BaseDialogComponent', () => {
    ...
    beforeEach(async () => {
        ...
        fixture.componentRef.setInput('dialogContentTemplate', undefined);
        fixture.componentRef.setInput('dialogFooterTemplate', undefined);
        fixture.componentRef.setInput('visibleInputSignal', signal(true));
