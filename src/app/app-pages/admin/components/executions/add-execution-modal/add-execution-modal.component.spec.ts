...
describe('AddExecutionModalComponent', () => {
    let component: AddExecutionModalComponent;
    let fixture: ComponentFixture<AddExecutionModalComponent>;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [AddExecutionModalComponent],
            providers: [getCommonComponentTestProviders()],
        });
        fixture = TestBed.createComponent(AddExecutionModalComponent);
