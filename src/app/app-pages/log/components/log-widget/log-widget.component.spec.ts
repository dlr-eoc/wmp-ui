...
describe('LogWidgetComponent', () => {
    let component: LogWidgetComponent;
    let fixture: ComponentFixture<LogWidgetComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [LogWidgetComponent],
            providers: [getCommonComponentTestProviders()],
        }).compileComponents();

        fixture = TestBed.createComponent(LogWidgetComponent);
