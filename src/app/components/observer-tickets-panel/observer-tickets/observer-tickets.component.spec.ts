...
describe('ObserverTicketsComponent', () => {
    let component: ObserverTicketsComponent;
    let fixture: ComponentFixture<ObserverTicketsComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [ObserverTicketsComponent],
         providers: [getCommonComponentTestProviders()]}).compileComponents();

        fixture = TestBed.createComponent(ObserverTicketsComponent);
