...
describe('JobChangeDialogComponent', () => {
    let component: JobChangeDialogComponent;
    let fixture: ComponentFixture<JobChangeDialogComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [JobChangeDialogComponent],
            providers: [getCommonComponentTestProviders()],
        }).compileComponents();

        fixture = TestBed.createComponent(JobChangeDialogComponent);

        fixture.componentRef.setInput('visibleInput', signal(true));
        fixture.componentRef.setInput('title', 'test');
        fixture.componentRef.setInput('selectedJobs', []);
