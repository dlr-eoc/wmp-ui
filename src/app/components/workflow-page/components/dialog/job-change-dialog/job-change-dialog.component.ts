...
@Component({
    selector: 'app-job-change-dialog',
    imports: [ConfirmCancelDialogComponent],
    templateUrl: './job-change-dialog.component.html',
    styleUrl: './job-change-dialog.component.scss',
})
export class JobChangeDialogComponent {
    ...
    selectedJobs = input.required<HistoricProcessInstance[]>();
}
